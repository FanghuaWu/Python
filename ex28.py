...
print("17. not(testing = tesing and Zed == Cool Guy)", not ("testing" == "testing" and "Zed" == "Cool Guy"))
...
print("20. 3 == 3 and (not(test == tesing or Python == Fun))", 3 == 3 and (not ("testing" == "testing" or "Python" == "Fun")))
